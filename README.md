...
A Windows-first, auditable pipeline for collecting, scanning, deduplicating, classifying, and organizing SillyTavern character cards. Every destructive-looking workflow is split into report generation, human approval, and verified execution.
...
- Organization stages create immutable plans first. Execution requires approval for the exact plan and validates hashes before writing.
