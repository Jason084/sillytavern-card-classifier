...
Model batch size is controlled by `MODEL_BATCH_SIZE`; the repository's example configuration defaults to 30 cards per batch, matching phase 050. See the [runbook](./docs/runbook.md) for phase-specific defaults, overrides, and resume constraints.
